...
//	//生成按钮
//	//本机1.5倍率，
//	Button* Adventure = MakeButton(512 - 275, 924, 100, 50, "修炼", RGB(137, 207, 240), RGB(185,96,49), RGB(30, 144, 255));
//	Button* Adventure1 = MakeButton(512 - 125, 924, 100, 50, "装备", RGB(137, 207, 240), RGB(185, 96, 49), RGB(30, 144, 255));
//	Button* Adventure2 = MakeButton(512 + 25, 924, 100, 50, "历练", RGB(137, 207, 240), RGB(185, 96, 49), RGB(30, 144, 255));
//	Button* Adventure3 = MakeButton(512 + 175, 924, 100, 50, "商城", RGB(137, 207, 240), RGB(185, 96, 49), RGB(30, 144, 255));
//	Button* Adventure4 = MakeButton(512 - 50, 800, 100, 50, "突破", RGB(137, 207, 240), RGB(185, 96, 49), RGB(30, 144, 255));
//	//绘制按钮
