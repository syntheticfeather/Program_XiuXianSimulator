...
void AdventureCase_2(struct Player_* Player) {
	...
	outtextxy(262 + 250 - textwidth("定睛一看,竟是炎帝萧炎的传承!修为增加十分之二,攻击提升.") / 2, 42 + 140, "定睛一看,竟是炎帝萧炎的传承!修为增加十分之四,攻击提升.");
...
//--------------------------------------------------//--------------------------------------------------//
//事件源码//
//一.无事发生 直接退出事件 N  20% 1-20
//二.觅得炎帝传承 修为大增 G 10% 21-30
//三.偶遇敌人1 战斗模块 胜利或失败 N 10% 31-40
//四.中陷阱 扣钱续命 B 10% 41-50
//五.误入毒瘴 扣属性 B 6% 51-56
//六.上古宗门传承 突破概率增长 G 7% 57-63
//七.合欢宗 N 10% 64-73
//八.天下武斗会 识得玄武门龟男学相册 交流修仙经验 G 15% 74-88
//九.东海秘境 获得千年蛟珠所化上品灵石 G 5% 89-93
//十. 修仙悬赏 为民除害 G 7% 94-100
//--------------------------------------------------//--------------------------------------------------//
//当按下历练按钮时,只需要调用该函数即可
